...
- Fixed LSP duplicate-alias diagnostics and quick fixes to attach to the exact frontmatter alias token when available, and to appear even when clients omit diagnostics from code-action requests.
